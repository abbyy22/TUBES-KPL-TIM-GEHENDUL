...
router.get('/', (req, res) => {
  res.json({
    ...
    endpoints: [
      ...
      'POST   /api/auth/login',
      'GET    /api/auth/me',
      'POST   /api/auth/avatar              (upload foto profil – multipart/form-data)',
      ...
      'POST   /api/menus/:id/photo          (upload foto menu – multipart/form-data, admin)',
      'DELETE /api/menus/:id/photo          (hapus foto menu, admin)',
      'POST   /api/orders',
      'GET    /api/orders/me',
